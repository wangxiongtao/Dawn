...
public class RSAUtil {
    ...
    private static String encryptByPublicKey(String data, RSAPublicKey publicKey)
        ...
        return Base64.encodeToString(mi.toString().getBytes(),Base64.DEFAULT);
    }
...
//        byte[] bytes = data.getBytes();
        ...
        return new String(ming.toString().getBytes(),"utf-8");
    }
    /**
     * ASCII码转BCD码
     *
...
//    }
     ...
     * @return
     */
    public static String encrypt(String key, String s2) {

        try {
            RSAPublicKey publicKey = RSAUtil.loadPublicKey(key);
            return encryptByPublicKey(s2,publicKey);
     ...
     * @return
     */
    public static String decrypt(String key, String s2) {
        try {
            RSAPrivateKey privateKey = RSAUtil.loadPrivateKey(key);
            return decryptByPrivateKey(s2,privateKey);
